...
const en: Dict = {
  ...
  'bracket.subtitle': 'Knockout stage bracket (FIFA-official pairings)',
  'bracket.tbd': 'TBD',
  ...
  'live.sectionFavorites': 'Favorites',
...
const zh: Dict = {
  ...
  'bracket.subtitle': '淘汰赛对阵（FIFA 官方配对）',
  'bracket.tbd': '待定',
  'bracket.R32': '1/8 决赛',
  'bracket.R16': '1/4 决赛',
  'bracket.QF': '半决赛',
...
const ja: Dict = {
  ...
  'bracket.subtitle': 'ノックアウトステージ表（FIFA 公式組み合わせ）',
  'bracket.tbd': '未定',
  'bracket.R32': 'ラウンド32',
  'bracket.R16': 'ラウンド16',
  'bracket.QF': '準々決勝',
...
const ko: Dict = {
  ...
  'bracket.subtitle': '결선 토너먼트 대진표 (FIFA 공식)',
  'bracket.tbd': '미정',
  'bracket.R32': '32강',
  'bracket.R16': '16강',
  'bracket.QF': '8강',
