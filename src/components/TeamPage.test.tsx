...
describe('TeamPage', () => {
  ...
  it('renders the team scorers section when scorers are present', () => {
    const scorers: TopScorer[] = [
      { athleteId: '1', name: 'Alvarado', teamId: '203', teamName: 'Mexico', goals: 3 },
      { athleteId: '2', name: 'Vega', teamId: '203', teamName: 'Mexico', goals: 1 },
      { athleteId: '3', name: 'Other Player', teamId: '999', teamName: 'Other', goals: 5 },
    ];
    renderPage({ scorers });
